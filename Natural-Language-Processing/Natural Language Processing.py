...
# https://www.tensorflow.org/tutorials/text/word_embeddings
# https://www.tensorflow.org/tutorials/text/word_embeddings_with_keras
...
if embeddings_path and embeddings_path.exists():
    try:
        ...
        print("The script will continue without embeddings, but accuracy may be lower.")
        embeddings = None
else:
    print("\n⚠️  No embeddings file found. The script will continue without embeddings.")
    print("Note: This will affect model accuracy, but the script will still run.")
    embeddings = None
...
if embeddings is not None:
    ...
    # Create a dummy vocabulary for the case when embeddings are not available
    vocabulary = ['dummy'] * 1000  # Create a dummy vocabulary
...
# Create TextVectorization layer (this was missing in the original script)
...
all_text_data = list(train_samples) + list(val_samples) + list(test_samples)
vectorizer.adapt(all_text_data)
